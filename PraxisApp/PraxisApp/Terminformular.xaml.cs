...
namespace PraxisApp {
    ...
    public partial class Terminformular : ContentPage {
        public Terminformular() {
            InitializeComponent();
            ...
            if(termin_art.SelectedItem == null)
                ...
                if(emailMessenger.CanSendEmail) {
                    ...
                    string mailBody = "---- Patient ----" + "\r\n" +
                        ...
                        "\r\n" +
                        "---- Termin ----" + "\r\n" +
                        "Art des Termins: " + termin_art.SelectedItem.ToString() + "\r\n" +
                        "Weitere Angaben: " + weitere_angaben.Text
                        ;

                    // Send simple e-mail to single receiver without attachments, bcc, cc etc.
                    emailMessenger.SendEmail("info@kinderarzt-elbvororte.de",
                        "Terminanfrage PraxisApp von " + eltern_vorname.Text + " " + eltern_nachname.Text + " (" + eltern_tel.Text + ")",
                        mailBody);
